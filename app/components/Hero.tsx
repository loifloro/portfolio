    ...
    return (
        <div className="min-h-screen text-center grid items-end md:p-12 p-4 relative">
            ...
            <div className="absolute min-h-screen w-full flex justify-end flex-col -z-10">
                ...
                <div className="h-screen w-full bg-[url(/png/hero-bg.png)] bg-no-repeat bg-fixed bg-cover bg-bottom dark:brightness-[.30] opacity-70 dark:opacity-100 contrast-[1.2] dark:contrast-[1.05] -z-10"></div>
            </div>
        </div>
    );
}
