...
export default function Hero() {
    ...
    return (
        <div className="overflow-hidden min-h-svh text-center grid items-end md:p-12 p-4 relative">
            <div>
            ...
            <div className="absolute min-h-svh w-full flex justify-end flex-col -z-10">
                <div className="absolute min-h-svh w-full bg-gradient-hero-bg flex items-end">
