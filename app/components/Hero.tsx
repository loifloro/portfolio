    ...
    return (
        <div className="min-h-screen text-center grid items-end md:p-12 p-4 relative">
            <div>
                ...
                <div className="flex justify-center gap-5 sm:gap-8 mt-6 mb-4 sm:mb-0 sm:mt-8">
                    <ArrowLink
                        name="LinkedIn"
                        isWithArrow
            ...
            <div className="absolute min-h-screen w-full flex justify-end flex-col -z-10">
                ...
                <Image
                    ...
                    quality={100}
                    className="dark:brightness-[.30] opacity-80 dark:opacity-100 contrast-[1.4] dark:contrast-[1.05] -z-10"
                />
            </div>
        </div>
    );
